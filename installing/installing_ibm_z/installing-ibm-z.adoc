...
[id="creating-machines-ibm-z"]
== Creating {op-system-first} machines

Before you install a cluster on IBM Z infrastructure that you provision,
you must create {op-system} machines for the cluster to use. Complete the following steps to create the machines.
